...
<table>
  <tr>
      <img width="100%" alt="Encoding Page Screenshot" src="https://github.com/user-attachments/assets/843123cd-7383-4a40-8ca0-e5c2ebfdc771" />
  </tr>
  <tr>
...
5.  [Important Security Note](#important-security-note-secret-key--network-traffic)
...
Image 1: The Bug - Jinja tag inside an HTML comment `<!-- -->` | Jinja Tag is `{% block %}` | HTML comment is everything inside `<!-- -->`
